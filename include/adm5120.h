...
#define ADM5120_MPMC_REG(_offset)\
	(*((volatile unsigned long *)(PA2VA(ADM5120_MPMC_BASE + (_offset)))))
...
#define ADM5120_INTC_REG(_reg)		\
	(*((volatile unsigned long *)(PA2VA(ADM5120_INTC_BASE + (_reg)))))
...
#define ADM5120_SW_REG(_reg)		\
	(*((volatile unsigned long *)(PA2VA(ADM5120_SWCTRL_BASE + (_reg)))))
...
#define UART_1200bps_DIVISOR				3254
